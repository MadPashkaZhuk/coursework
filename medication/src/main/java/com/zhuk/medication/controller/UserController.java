...
public class UserController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "Only admin can see users.")
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "401", description = "User is not authorized."),
            @ApiResponse(responseCode = "403", description = "Only admin can see users."),
            @ApiResponse(responseCode = "404", description = "Error code 8001: User with this username doesn't exists")
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "Error code 8002: Username you are trying to change to already exists."),
            @ApiResponse(responseCode = "401", description = "User is not authorized."),
